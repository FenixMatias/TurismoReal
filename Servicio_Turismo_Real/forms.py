...
from .models import ArticuloDepartamento, ImagenDepartamento, Departamento, Funcionario, Cargo, DetalleCostoDepartamento, Carro
...
class CarroForm(ModelForm):
    ...
    class Meta:
        model = Carro
        fields = ['carro_cantidad']
        widgets = {
        	'carro_cantidad': NumberInput(
				attrs={
					'class': 'form-control'
				}
			),
